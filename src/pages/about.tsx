...
export default function About() {
  return (
    <>
      <NextSeo
        title="About Ankur Gajurel | Cloud and Dev Engineer"
        description="Learn more about Ankur gajruel, a Cloud Enthusiast with 1 year of experience - deploying and managing cloud infrastructure on AWS."
        canonical={`${siteMetadata.siteUrl}/about`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/about`,
          title: "Learn About Ankur Gajurel - Cloud and Dev Engineer",
          description:
            "Dive into the story of Ankur Gajurel, a Cloud and Dev Engineer with 1 year of experience - deploying and managing cloud infrastructure on AWS.",
          images: [
            {
        ...
        additionalMetaTags={[
          {
            property: "keywords",
            content:
              "About Me, DevOps Enginerr, React Developer, Frontend Developer, Web Developer, JavaScript, HTML, CSS, Professional Journey, Skills, Passion for Web Development",
          },
        ]}
      />
        ...
        <div className="sm:1/2 mt-10 w-full lg:w-1/2">
          <AnimatePresence>
            ...
            >
              ...
              <span className="text-lg font-medium">Kathmandu, Nepal</span>
            </FadeRight>
          </AnimatePresence>
        </div>
      </div>
