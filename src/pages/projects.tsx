...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Ankur Gajurel - Cloud and Developer Portfolio"
        description="Explore a collection of projects by Ankur Gajurel. From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
        canonical={`${siteMetadata.siteUrl}/projects`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/projects`,
          title:
            "Discover Projects by Ankur Gajurel - Cloud and Developer Portfolio",
          description:
            "Explore a showcase of projects crafted by Ankur Gajurel, a React and Frontend Developer. Witness the fusion of creativity and technology in web development.",
          images: [
            {
